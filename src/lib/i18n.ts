...
const extraDict: Dict = {
  ...
  'dash.tab.feedback':      { EN: 'Feedback',               ID: 'Masukan',                     JP: 'フィードバック'               },
  'feedback.title':         { EN: 'Share Feedback',          ID: 'Kirim Masukan',               JP: 'フィードバックを送る'         },
  'feedback.subtitle':      { EN: 'Help us improve Arcade Track. Your feedback goes directly to the admin.', ID: 'Bantu kami tingkatkan Arcade Track. Masukanmu langsung diterima admin.', JP: 'Arcade Trackの改善にご協力ください。フィードバックは管理者に届きます。' },
  'feedback.category':      { EN: 'Category',                ID: 'Kategori',                    JP: 'カテゴリ'                    },
  'feedback.cat.general':   { EN: 'General',                 ID: 'Umum',                        JP: '一般'                        },
  'feedback.cat.suggestion':{ EN: 'Suggestion',              ID: 'Saran',                       JP: '提案'                        },
  'feedback.cat.bug':       { EN: 'Bug Report',              ID: 'Laporan Bug',                 JP: 'バグ報告'                    },
  'feedback.cat.praise':    { EN: 'Praise',                  ID: 'Apresiasi',                   JP: '称賛'                        },
  'feedback.rating':        { EN: 'Experience Rating',       ID: 'Rating Pengalaman',           JP: '体験評価'                    },
  'feedback.rating.skip':   { EN: 'Skip rating',             ID: 'Lewati rating',               JP: '評価をスキップ'              },
  'feedback.message':       { EN: 'Your message',            ID: 'Pesanmu',                     JP: 'メッセージ'                  },
  'feedback.placeholder':   { EN: 'What would you like to share? (min. 5 characters)', ID: 'Apa yang ingin kamu sampaikan? (min. 5 karakter)', JP: '何を共有しますか？（5文字以上）' },
  'feedback.submit':        { EN: 'Send Feedback',           ID: 'Kirim Masukan',               JP: 'フィードバックを送信'         },
  'feedback.submitting':    { EN: 'Sending…',                ID: 'Mengirim…',                   JP: '送信中…'                     },
  'feedback.success':       { EN: 'Thank you! Your feedback has been sent.',  ID: 'Terima kasih! Masukanmu telah terkirim.', JP: 'ありがとうございます！フィードバックが送信されました。' },
  'feedback.error':         { EN: 'Failed to send. Please try again.',        ID: 'Gagal mengirim. Silakan coba lagi.',      JP: '送信に失敗しました。もう一度お試しください。' },
  'feedback.error.short':   { EN: 'Message must be at least 5 characters.',  ID: 'Pesan minimal 5 karakter.',              JP: 'メッセージは5文字以上必要です。'           },
  'feedback.error.limit':   { EN: 'Feedback limit reached. Try again in an hour.', ID: 'Batas pengiriman tercapai. Coba lagi dalam satu jam.', JP: '送信制限に達しました。1時間後に再度お試しください。' },
  'feedback.chars':         { EN: '{n} / 2000',              ID: '{n} / 2000',                  JP: '{n} / 2000'                  },
...
const pass2Dict: Dict = {
  ...
  'player.feat.tracks.desc':   { EN: '6 active tracks with badge images', ID: '6 track aktif dengan gambar badge', JP: 'バッジ画像付きのアクティブなトラックが6つ' },

...
const pass2Dict: Dict = {
  ...
  'admin.mentor_title':     { EN: 'Mentor Utama',            ID: 'Mentor Utama',              JP: 'メンターウタマ'             },
  ...
  'admin.tab.unsynced':     { EN: '⚠︎ Unsynced',             ID: '⚠︎ Belum Sinkron',           JP: '⚠︎ 未同期'                  },
  ...
  'admin.unsynced_n':       { EN: '⚠︎ Unsynced ({n})',       ID: '⚠︎ Belum Sinkron ({n})',    JP: '⚠︎ 未同期 ({n})'           },
  ...
  'admin.sync.locked_warn': { EN: '⚠︎ Disable maintenance mode first.', ID: '⚠︎ Nonaktifkan mode pemeliharaan terlebih dahulu.', JP: '⚠︎ まず メンテナンスモードを無効化してください。' },
